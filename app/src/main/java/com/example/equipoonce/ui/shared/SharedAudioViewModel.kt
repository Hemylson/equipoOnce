package com.example.equipoonce.ui.shared
...
/**
 * ViewModel compartido de audio a nivel de Activity.
 * ViewModel puro — recibe GameAudioManager por constructor (DI manual).
 * Sin referencias a Android — completamente testeable.
 */
class SharedAudioViewModel(private val audioManager: GameAudioManager) : ViewModel() {
